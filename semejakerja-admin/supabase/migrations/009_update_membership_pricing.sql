-- ============================================================
-- 009: Update membership pricing
--
-- Repricing (supersedes the price table baked into 008):
--   Nongkrong   — bulanan 31000 → 19000, triwulan 85000  → 47000
--   Mode Serius — bulanan 69000 → 31000, triwulan 185000 → 77000
--   (triwulan ≈ "bayar 2,5 bulan", ~17% hemat)
--
-- Only the v_base price table changed vs 008 — the rest of the
-- function (promo validation, dedupe, insert) is identical. Kept as a
-- full CREATE OR REPLACE so the live function definition stays in sync.
-- Landing mirrors: membership/page.tsx + membership/checkout/page.tsx.
-- ============================================================
